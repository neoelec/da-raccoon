...
extern void SPLT_Init(struct SPLT *tree,
                      int (*Compare)(const struct SPLT_Node *,
...
extern struct SPLT_Node *SPLT_Search(const struct SPLT *tree,
...
extern void SPLT_Forward(struct SPLT *tree,
                         void (*Call)(struct SPLT_Node *, void *),
                         void *private);
extern void SPLT_Backward(struct SPLT *tree,
                          void (*Call)(struct SPLT_Node *, void *),
                          void *private);
extern void SPLT_Preorder(struct SPLT *tree,
                          void (*Call)(struct SPLT_Node *, void *),
                          void *private);
extern void SPLT_Inorder(struct SPLT *tree,
                         void (*Call)(struct SPLT_Node *, void *),
                         void *private);
extern void SPLT_Postorder(struct SPLT *tree,
                           void (*Call)(struct SPLT_Node *, void *),
                           void *private);
