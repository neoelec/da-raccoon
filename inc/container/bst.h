...
extern void BST_Init(struct BST *tree, int (*Compare)(const struct BST_Node *,
                                                      const struct BST_Node *));
...
extern struct BST_Node *BST_Search(const struct BST *tree,
...
extern void BST_Forward(struct BST *tree,
                        void (*Call)(struct BST_Node *, void *), void *private);
extern void BST_Backward(struct BST *tree,
                         void (*Call)(struct BST_Node *, void *),
                         void *private);
extern void BST_Preorder(struct BST *tree,
                         void (*Call)(struct BST_Node *, void *),
                         void *private);
extern void BST_Inorder(struct BST *tree,
                        void (*Call)(struct BST_Node *, void *), void *private);
extern void BST_Postorder(struct BST *tree,
                          void (*Call)(struct BST_Node *, void *),
                          void *private);
